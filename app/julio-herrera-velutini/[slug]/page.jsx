...
import JulioRedirect from "@/components/JulioRedirect";
...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.read-more-about.com/politics/${slug}/`,
    },
  };
}

export default function Page() {
  return <JulioRedirect />;
}
...
//     description: article.metaDescription,
//     keywords: article.keywords?.join(", "),
//     alternates: { canonical: `${SITE_URL}/politics/${slug}/` },
//     openGraph: {
//       title: article.metaTitle,
//       description: article.metaDescription,
//       url: `${SITE_URL}/${PILLAR_BASE}/${slug}`,
