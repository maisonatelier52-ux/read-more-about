...
// OPTIMIZED VERSION - app/[category]/[slug]/page.jsx
// Key changes:
// 1. Reduced hero height on mobile (450px → 380px)
// 2. Lowered quality to 75 (was 85)
// 3. Already has priority and placeholder (good!)
// 4. Added better responsive sizes
    ...
    <>
      ...
      <div className="w-full" itemScope itemType="https://schema.org/NewsArticle">
        ...
        <div className='px-4 lg:px-7'>
          ...
          {/* OPTIMIZED HERO IMAGE - KEY LCP FIX */}
          <div className="relative w-full h-[380px] sm:h-[480px] md:h-[550px] lg:h-[650px] mt-10">
            <Image
              src={article.image}
              alt={article.imageAlt}
              fill
