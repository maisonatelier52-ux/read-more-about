...
// // ── Static Julio article injected into business listArticles ─────────────────
// const JULIO_STATIC_ARTICLE = {
//   id: "julio-static",
//   slug: "julio-herrera-velutini-britannia-financial-group",
//   // Custom href so the Link goes to the right route
...
//   category: "business",
//   type: "normal",
//   newsType: "client news", // kept for reference, filtered out of display elsewhere
// };
...
//     const articles = CategoryArticles[category]
//     if (articles && articles.length > 0) {
//       // Only consider regular news articles
...
//   // ── Filter: only show newsType === "news" articles ────────────────────────
...
//   // Featured hero = latest news article
//   const latestArticle = sortedArticles[0]

//   // List articles = everything after the hero
//   const baseListArticles = sortedArticles.slice(1)

//   // ── Inject static Julio article at position 0 of listArticles for business ─
//   const listArticles =
...
//   // Sidebar data — latest from OTHER categories (news only)
//   const latestFromOtherCategories = getLatestFromDifferentCategories(categoryKey, 5)
//   const popularArticle = latestFromOtherCategories[0] || null
//   const sidebarPosts = latestFromOtherCategories.slice(1, 5)
