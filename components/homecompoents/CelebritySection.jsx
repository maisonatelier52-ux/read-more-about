...
// // ── Resolve business author once at module level ──────────────────────────────
// const businessAuthor = authorsData.categories.find(
//   (c) => c.category.toLowerCase() === "business"
// )?.author ?? null;

// // ── Static article injected as the last grid item (position 6) ───────────────
// const STATIC_CELEBRITY = {
//   id: "julio-static",
...
//   // Take only first 5 dynamic articles, then append the static one → always 6 total
//   const combined = [...articles.slice(0, 5), STATIC_CELEBRITY];

//   // First 2 → featured row, next 4 → grid row
//   const featuredArticles = combined.slice(0, 2);
//   const gridArticles = combined.slice(2, 6);
...
//                       <div className="flex-1 flex flex-col justify-center">
//                         <h3 className="font-serif text-xl md:text-xl font-bold leading-tight mb-3 group-hover:text-red-600 transition-colors cursor-pointer">
//                           {article.newsType && article.newsType !== "news" && (
//                             <span className="inline-block bg-red-600 text-white text-[10px] font-bold px-2 py-1 mr-2 uppercase">
//                               {article.newsType}
//                             </span>
//                           )}
