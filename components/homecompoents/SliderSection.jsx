...
//   title: "Julio Herrera Velutini: From Venezuela's Banking Dynasty to the World of Finance",
//   date: "23/02/2026",
//   type: "normal",
// };
...
//   // Prepend the static slide to the dynamic articles
...
//           <button
//             onClick={handleNext}
//             disabled={startIndex + ITEMS_PER_VIEW >= allArticles.length}
//             className="h-10 w-10 flex items-center justify-center rounded-full bg-gray-300 text-white disabled:opacity-50 cursor-pointer disabled:cursor-default"
//             aria-label="Next articles"
//           >
//             <FaChevronRight />
